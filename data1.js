...
const REAL = {
  ...
  gpp:{
    /* สำนักงานสภาพัฒนาการเศรษฐกิจและสังคมแห่งชาติ — ผลิตภัณฑ์ภาคและจังหวัด แบบปริมาณลูกโซ่ ฉบับ พ.ศ. 2567
       จังหวัดหนองบัวลำภู รหัส 0118 · แฟ้ม GPP-2024-On-Web-1995-2024
       value = มูลค่า ณ ราคาประจำปี (ล้านบาท) · pc = ต่อหัว (บาท/คน/ปี) · pop = ประชากรกลางปีที่ สศช. ใช้เป็นตัวหาร
       cvm   = มูลค่าแบบปริมาณลูกโซ่ (ล้านบาท) ใช้ดูการเติบโตจริงที่ตัดผลของราคาออกแล้ว
       note  = ปรับปรุง (revised) หรือ เบื้องต้น (preliminary) ตามที่ สศช. กำกับไว้ในแฟ้มต้นทาง */
    src:'สำนักงานสภาพัฒนาการเศรษฐกิจและสังคมแห่งชาติ', doc:'ผลิตภัณฑ์ภาคและจังหวัด แบบปริมาณลูกโซ่ ฉบับ พ.ศ. 2567',
    structYear:2567, structTotal:34699.7,
    rows:[
      {"y": 2558, "value": 23818.7, "pc": 49296.0, "pop": 483173, "cvm": 15891.0, "note": ""},
      {"y": 2559, "value": 26997.4, "pc": 56081.0, "pop": 481399, "cvm": 16963.1, "note": ""},
      {"y": 2560, "value": 27886.3, "pc": 58120.0, "pop": 479803, "cvm": 17152.0, "note": ""},
      {"y": 2561, "value": 29096.8, "pc": 60867.0, "pop": 478038, "cvm": 18553.0, "note": ""},
      {"y": 2562, "value": 28661.8, "pc": 60185.0, "pop": 476228, "cvm": 18079.6, "note": ""},
      {"y": 2563, "value": 28242.8, "pc": 59537.0, "pop": 474374, "cvm": 17336.9, "note": "ปรับปรุง"},
      {"y": 2564, "value": 30580.2, "pc": 64723.0, "pop": 472476, "cvm": 18363.8, "note": "ปรับปรุง"},
      {"y": 2565, "value": 32158.9, "pc": 68346.0, "pop": 470529, "cvm": 18708.5, "note": "ปรับปรุง"},
      {"y": 2566, "value": 32150.4, "pc": 68620.0, "pop": 468526, "cvm": 18282.9, "note": "ปรับปรุง"},
      {"y": 2567, "value": 34699.7, "pc": 74390.0, "pop": 466459, "cvm": 19338.7, "note": "เบื้องต้น"}
    ],
    /* โครงสร้างเศรษฐกิจครบทั้ง 19 สาขา ณ ราคาประจำปี ทุกปีตั้งแต่ 2558
       sec = [ชื่อสาขา, หมวดใหญ่] เรียงตามลำดับเดียวกับตัวเลขในแต่ละปี
       secVal = { ปี: [มูลค่าเพิ่ม 19 สาขา ล้านบาท] } ผลรวมแต่ละปีเท่ากับ GPP ของปีนั้น */
    sec:[
      ["เกษตรกรรม การป่าไม้ และการประมง", "เกษตร", "agri", "agri"],
      ["การทำเหมืองแร่และเหมืองหิน", "อุตสาหกรรม", "industry", ""],
      ["การผลิต", "อุตสาหกรรม", "factorynew", "factorynew"],
      ["ไฟฟ้า ก๊าซ และระบบปรับอากาศ", "อุตสาหกรรม", "power", "power"],
      ["ประปาและการจัดการของเสีย", "อุตสาหกรรม", "water", "water"],
      ["การก่อสร้าง", "บริการ", "invest", "invest"],
      ["ขายส่ง ขายปลีก ซ่อมยานยนต์", "บริการ", "trade", "trade"],
      ["ขนส่งและสถานที่เก็บสินค้า", "บริการ", "vehicle", "vehicle"],
      ["ที่พักแรมและบริการอาหาร", "บริการ", "accommodation", "accommodation"],
      ["ข้อมูลข่าวสารและการสื่อสาร", "บริการ", "network", ""],
      ["การเงินและการประกันภัย", "บริการ", "credit", "credit"],
      ["อสังหาริมทรัพย์", "บริการ", "household", "household"],
      ["วิชาชีพ วิทยาศาสตร์ และเทคนิค", "บริการ", "analysis", "gpp"],
      ["การบริหารและบริการสนับสนุน", "บริการ", "admin", "spend"],
      ["บริหารราชการและการป้องกันประเทศ", "บริการ", "localgov", "fiscal"],
      ["การศึกษา", "บริการ", "row-learncenter", ""],
      ["สุขภาพและสังคมสงเคราะห์", "บริการ", "social", "social"],
      ["ศิลปะ บันเทิง และนันทนาการ", "บริการ", "award", "otopstar"],
      ["บริการด้านอื่น ๆ", "บริการ", "row-houseware", "otop"]
    ],
    /* อัตราการขยายตัวที่แท้จริงรายปี (%) คำนวณจากมูลค่าแบบปริมาณลูกโซ่
       prov = GPP จังหวัดหนองบัวลำภู · nat = GDP ทั้งประเทศ จากแฟ้มเดียวกัน แผ่น WK */
    growth:[
      {"y": 2556, "prov": 5.07, "nat": 2.69},
      {"y": 2557, "prov": 3.47, "nat": 0.98},
      {"y": 2558, "prov": 3.22, "nat": 3.13},
      {"y": 2559, "prov": 6.75, "nat": 3.44},
      {"y": 2560, "prov": 1.11, "nat": 4.18},
      {"y": 2561, "prov": 8.17, "nat": 4.22},
      {"y": 2562, "prov": -2.55, "nat": 2.11},
      {"y": 2563, "prov": -4.11, "nat": -6.09},
      {"y": 2564, "prov": 5.92, "nat": 1.56},
      {"y": 2565, "prov": 1.88, "nat": 2.64},
      {"y": 2566, "prov": -2.27, "nat": 2.25},
      {"y": 2567, "prov": 5.77, "nat": 2.95}
    ],
    secVal:{
      "2558":[5979.2,254.5,4127.7,274.6,61.4,1120.1,2663.9,529.0,23.6,229.8,1636.8,1221.6,1.9,14.6,1044.1,3629.0,714.3,41.2,251.3],
      "2559":[6064.4,334.8,5408.4,291.3,70.9,1157.2,3432.7,608.7,24.1,210.3,1926.0,1716.3,1.6,17.8,1047.2,3629.4,748.8,51.9,255.6],
      "2560":[6597.7,363.8,5119.0,303.8,96.8,1052.4,3926.5,718.6,27.0,245.9,2069.3,1309.3,1.7,15.3,1095.7,3808.0,812.7,65.0,257.7],
      "2561":[7019.3,358.2,5144.6,274.6,94.1,1323.8,4119.9,686.1,30.5,263.5,2207.4,1450.4,1.9,14.3,1188.5,3651.9,874.9,80.4,312.6],
      "2562":[6272.4,292.5,5435.8,310.2,95.8,1340.0,4210.5,768.4,32.9,308.2,2168.5,1404.7,2.5,14.2,1192.8,3544.5,863.9,94.1,310.0],
      "2563":[5841.1,375.1,4830.6,335.9,110.5,1439.3,4207.0,667.0,24.3,317.3,2320.4,1541.1,2.8,9.7,1271.2,3609.4,889.5,154.5,296.2],
      "2564":[6459.6,377.4,5822.2,370.9,175.0,1615.2,4431.1,796.0,23.7,314.8,2283.7,1498.6,5.5,8.6,1319.6,3679.5,945.2,163.1,290.5],
      "2565":[7293.6,360.6,6457.4,344.4,196.7,1515.4,4085.3,903.2,30.8,310.8,2515.0,1559.6,4.0,11.8,1324.0,3759.7,1009.2,194.0,283.1],
      "2566":[7639.6,437.2,6223.4,475.3,197.3,754.7,3986.0,957.5,37.8,299.5,2644.4,1576.3,5.9,12.5,1398.5,3867.6,1055.7,240.8,340.6],
      "2567":[8661.2,438.8,6450.8,467.3,220.5,787.3,4153.1,1043.6,44.7,320.3,2569.1,1714.0,6.7,14.9,1683.2,4022.1,1211.8,276.5,613.8]
    }
  }
};
